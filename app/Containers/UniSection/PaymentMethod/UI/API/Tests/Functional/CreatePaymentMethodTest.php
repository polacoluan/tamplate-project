 ...
 * @group api
 */
class CreatePaymentMethodTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/payment-methods';
    ...
    // TODO TEST
    // public function testCreatePaymentMethodWithInvalidFields(): void
    // {
    //     $data = [
    ...
    // public function testGivenHaveNoAccess_CannotCreatePaymentMethod(): void
    // {
