 ...
 * @group api
 */
class CreatePaymentTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/payment';
    ...
    // TODO TEST
    // public function testCreatePaymentWithInvalidFields(): void
    // {
    //     $data = [
    ...
    // public function testGivenHaveNoAccess_CannotCreatePayment(): void
    // {
